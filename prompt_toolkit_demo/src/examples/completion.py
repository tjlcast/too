...
def run():
    ...
    animal_completer = WordCompleter(
        ['cat', 'dog', 'elephant', 'fox', 'giraffe', 'horse'])
    ...
    fuzzy_completer = FuzzyWordCompleter(
        ['cat', 'dog', 'elephant', 'fox', 'giraffe', 'horse'])
    fuzzy_animal = prompt("Choose an animal (fuzzy): ",
    ...
    command_words = list(commands.keys(
    )) + [subitem for sublist in commands.values() for subitem in sublist]
